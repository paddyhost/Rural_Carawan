...
public class WebServiceUrls
{
    ...
    public static final String urlGetStateList = "http://www.hatchers.in/caravan/index.php/api/v1/getStateList";

    public static final String urlAddCustomer = "http://www.hatchers.in/caravan/index.php/api/V1/addNewCustomerInquery";
    public static final String urlAddKitchenToServer = "http://www.hatchers.in/caravan/index.php/api/V1/addKitchenSuitability";
